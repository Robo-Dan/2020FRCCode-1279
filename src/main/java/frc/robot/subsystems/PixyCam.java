...
{
    private final static Pixy2 pixy = Pixy2.createInstance(new SPILink()); // Creates a new Pixy2 camera using SPILink;
	...
	public static Block getBiggestBlock() {
        ...
        final ArrayList<Block> blocks = pixy.getCCC().getBlocks(); // Gets a list of all blocks found by the Pixy2
