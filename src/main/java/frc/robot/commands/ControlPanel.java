...
{
  private final ControlPanelSub controlPanel;
  /**
   * Creates a new ControlPanel.
   */
  public ControlPanel(ControlPanelSub subForControlPanel)
  {
    controlPanel = subForControlPanel;
